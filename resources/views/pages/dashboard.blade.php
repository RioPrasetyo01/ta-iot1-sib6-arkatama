    ...
    <div class="col-lg-4">
        <div class="iq-card iq-card-block iq-card-stretch iq-card-height animation-card">
            <div class="iq-card-body p-0">
                ...
                <div class="an-img">
                    <div class="bodymovin" data-bm-path="images/small/data.json"
                        data-bm-renderer="svg" data-bm-loop="true"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="iq-card-body">
                    ...
                    <div class="col-sm-8">
                        <div class="media-sellers">
                            <div class="media-sellers-img">
                                <img src="images/page-img/01.jpg" class="mr-3 rounded"
                                    alt="">
                            </div>
                ...
                <div class="row mt-4">
                    <div class="col-sm-8">
                        <div class="media-sellers">
                            <div class="media-sellers-img">
                                <img src="images/page-img/02.jpg" class="mr-3 rounded"
                                    alt="">
                            </div>
                            <div class="media-sellers-media-info">
                                ...
                                <div class="sellers-dt">
                                    <span class="font-size-12">Vendor: <a
                                            href="#">Apple</a></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-sm-8">
                        <div class="media-sellers">
                            <div class="media-sellers-img">
                                <img src="images/page-img/03.jpg" class="mr-3 rounded"
                                    alt="">
                            </div>
                            <div class="media-sellers-media-info">
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    ...
                    <div class="iq-card-body">
                        <div class="media-support">
                            <div class="media-support-header mb-2">
                                <div class="media-support-user-img mr-3">
                                    <img class="rounded-circle" src="images/user/1.jpg"
                                        alt="">
                                </div>
                        ...
                        <div class="media-support">
                            <div class="media-support-header mb-2">
                                <div class="media-support-user-img mr-3">
                                    <img class="rounded-circle" src="images/user/02.jpg"
                                        alt="">
                                </div>
                                <div class="media-support-info mt-2">
                        ...
                        <div class="media-support">
                            <div class="media-support-header mb-2">
                                <div class="media-support-user-img mr-3">
                                    <img class="rounded-circle" src="images/user/03.jpg"
                                        alt="">
                                </div>
                                <div class="media-support-info mt-2">
                        ...
                        <div class="media-support">
                            <div class="media-support-header mb-2">
                                <div class="media-support-user-img mr-3">
                                    <img class="rounded-circle" src="images/user/04.jpg"
                                        alt="">
                                </div>
                                <div class="media-support-info mt-2">
                            ...
                            <div class="col-lg-6">
                                <div class="p-4">
                                    <div class=" d-flex align-items-center">
                                        <a href="#"
                                            class="iq-icon-box rounded-circle iq-bg-primary">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-lg-6">
                                <div class="p-4">
                                    <div class=" d-flex align-items-center">
                                        <a href="#"
                                            class="iq-icon-box rounded-circle iq-bg-success">
